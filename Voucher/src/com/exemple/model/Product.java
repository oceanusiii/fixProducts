...
public class Product implements Parcelable {
	...
	public Product(String id, String code_id, String name, 
	...
	public Product(Parcel a) {
		...
		create_date = a.readString();
		code_id =a.readString();
	}
	...
	public void writeToParcel(Parcel a, int flags) {
		...
		a.writeString(create_date);
		a.writeString(code_id);
